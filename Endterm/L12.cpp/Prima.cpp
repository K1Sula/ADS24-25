...
public:
    ...
    void minHeapify(int i){
        ...
        if(content[l].second.first<content[largest].second.first && l<heap_size)//problem
            largest = l;
        if(content[r].second.first<content[largest].second.first&& r<heap_size)//problem
            largest = r;
    ...
    void heapSort(){
        buildMinHeap();// at this point largest number is at root
